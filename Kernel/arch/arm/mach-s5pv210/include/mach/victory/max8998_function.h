...
===========================================================================*/
extern pmic_status_type pmic_read(byte slave, byte reg, byte * data,
				  byte length);
...
===========================================================================*/
extern pmic_status_type pmic_write(byte slave, byte reg, byte * data,
				   byte length);
...
===========================================================================*/
extern void Set_MAX8998_PM_ONOFF_CNTL(byte onoff_reg, byte cntl_item,
				      byte status);
...
===========================================================================*/
extern void Set_MAX8998_PM_ADISCHG_EN(byte adischg_en_reg, byte cntl_item,
				      byte status);
...
===========================================================================*/
extern boolean Set_MAX8998_PM_BUCK1_2_Voltage(max8998_pm_section_type ldo_num,
					      out_voltage_type set_value);
...
===========================================================================*/
extern boolean Set_MAX8998_PM_BUCK4_Voltage(max8998_pm_section_type ldo_num,
					    out_voltage_type set_value);
...
===========================================================================*/
extern boolean Set_MAX8998_PM_LDO2_3_Voltage(max8998_pm_section_type ldo_num,
					     out_voltage_type set_value);
...
===========================================================================*/
extern boolean
Set_MAX8998_PM_BUCK3_LDO4TO7_11_17_Voltage(max8998_pm_section_type ldo_num,
					   out_voltage_type set_value);
...
===========================================================================*/
extern boolean Set_MAX8998_PM_LDO8_Voltage(max8998_pm_section_type ldo_num,
					   out_voltage_type set_value);
...
===========================================================================*/
extern boolean Set_MAX8998_PM_LDO9_Voltage(max8998_pm_section_type ldo_num,
					   out_voltage_type set_value);
...
===========================================================================*/
extern boolean Set_MAX8998_PM_LDO10_Voltage(max8998_pm_section_type ldo_num,
					    out_voltage_type set_value);
...
===========================================================================*/
extern boolean Set_MAX8998_PM_LDO12_13_Voltage(max8998_pm_section_type ldo_num,
					       out_voltage_type set_value);
...
===========================================================================*/
extern boolean Set_MAX8998_PM_LDO14_15_Voltage(max8998_pm_section_type ldo_num,
					       out_voltage_type set_value);
...
===========================================================================*/
extern boolean Set_MAX8998_PM_LDO16_Voltage(max8998_pm_section_type ldo_num,
					    out_voltage_type set_value);
...
===========================================================================*/
extern boolean Set_MAX8998_PM_OUTPUT_Voltage(max8998_pm_section_type ldo_num,
					     out_voltage_type set_value);
...
===========================================================================*/
extern void Set_MAX8998_PM_LBCNFG(max8998_pm_section_type cntl_item,
				  lbcnfg_type lbcnfg);
...
===========================================================================*/
extern boolean Set_MAX8998_RTC_REG(max8998_rtc_section_type reg_num,
				   byte value);
...
===========================================================================*/
extern boolean Get_MAX8998_RTC_REG(max8998_rtc_section_type reg_num,
				   byte * reg_buff);
...
===========================================================================*/
extern boolean Get_MAX8998_RTC_ADDR(max8998_rtc_reg_type reg_addr,
				    byte * reg_buff);
...
===========================================================================*/
extern boolean Set_MAX8998_RTC(max8998_rtc_cmd_type rtc_cmd,
			       byte * max8998_rtc_ptr);
...
===========================================================================*/
extern boolean Get_MAX8998_RTC(max8998_rtc_cmd_type rtc_cmd,
			       byte * max8998_rtc_ptr);
...
===========================================================================*/
extern void Set_MAX8998_PM_IRQ(max8998_pm_section_type reg_num,
			       void (*max8998_isr) (void));
