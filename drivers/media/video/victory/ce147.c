...
/** 
 * ce147_power_on: Power on the camera sensor 
...
/** 
 * ce147_power_off: Power off the camera sensor 
 * Use only for updating camera firmware
 * Returns 0 forever
 */
...
static int ce147_get_main_sw_fw_version(struct v4l2_subdev *sd)
{
	...
	char fw_data[36] = {0, }; //Seccamera_victory aswoogi 20->36
	int fw_size = 0;
...
static int ce147_load_fw(struct v4l2_subdev *sd)
{
	 ...
	 */
        //msleep(10);//SecFeature.Camera aswoogi
        ...
        msleep(700);//SecFeature.Camera aswoogi
...
#elif  defined(CONFIG_ARIES_VER_B2)// Victory ansari
	unsigned char ce147_str_model[9] = "SPH-D700\0";
#else // Modify NTTS1
...
static int ce147_s_ctrl(struct v4l2_subdev *sd, struct v4l2_control *ctrl)
{
	...
	case V4L2_CID_CAMERA_SET_AUTO_FOCUS:
                ce147_set_preflash(sd, 0); //SecFeature.Camera aswoogi
